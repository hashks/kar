...
<div className="container mx-auto p-2 text-center pt-15">
         ...
         <RowRiwayat jenjang="SD" sekolah="SDN Cikidang 2" tahun="2010" />
         <RowRiwayat jenjang="SMP" sekolah="SMPN 1 Bantarujeg" tahun="2016" />
         <RowRiwayat jenjang="SMK" sekolah="SMAN 1 Bantarujeg" tahun="2019" />
